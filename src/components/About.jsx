            ...
            <div className="flex flex-wrap justify-center items-center ">
                <div className="w-full lg:w-1/2">
                    <div className="flex p-20 flex-wrap items-center justify-center">
                        <img src={Pic} alt="Profile Picture" className=" shadow-pic border border-primary border-width-100px border-b hover:cursor-pointer" />
                    </div>
                </div>
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col flex-wrap p-20 justify-center items-center lg:justify-start">
                        <p className="prose text-lg text-gray-600 dark:text-gray-300">
                            <span className="font-bold">Software development</span> has been an interest of mine since high school. Programming isn't just a skill for me, it's a passion. I enjoy the process of turning ideas into reality through code, leveraging my critical thinking skills to develop elegant and efficient solutions to complex problems. I am a <span className="font-bold">problem solver</span> who thrives in challenging environments and I love finding innovative ways to solve <span className="font-bold">real world problems</span>.
                        </p>
                    </div>
                </div>
            </div>
            <div className="flex flex-wrap justify-center w-full p-10 px-20 items-center">
