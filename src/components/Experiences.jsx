    ...
    <div className="w-full pb-4 m-14">
      <div className="flex  flex-col justify-center items-center m-5">
        ...
        <div className="flex flex-col justify-center items-center p-5 gap-10 w-5/6">
          {/*Tech@RBC*/}
          <motion.div whileHover={{ scale: 1.1 }} className="flex flex-col md:flex-row justify-start items-start mr-12 p-5 gap-3 md:gap-10 bg-gradient-to-r from-white to-pink-50 dark:from-pink-50 dark:to-pink-600 rounded-3xl shadow-lg w-11/12">
