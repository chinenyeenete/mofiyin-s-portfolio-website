    ...
    <div className="w-full pb-4 m-14">
      <div className="flex  flex-col justify-center items-center m-5">
        ...
        <div className="flex flex-col justify-center items-center p-5 gap-10 w-5/6">
          {/*Tech@RBC*/}
          <div className="flex flex-row justify-start items-start mr-12 p-5 gap-10 bg-gradient-to-r from-white to-pink-50 dark:from-pink-50 dark:to-pink-600 rounded-3xl shadow-lg w-11/12">
            <p className="text-gray-700 dark:text-white font-bold text-2xl p-5 2xl:text-5xl md:text-4xl text-shadow-lg md:text-shadow-lg text-lg text-center w-1/2"> Tech@RBC Women's Advisory Program</p>
            <div className="flex flex-col justify-start items-start p-5 gap-3 w-1/2">
          ...
          {/*DeltaHacks*/}
          <div className="flex flex-row justify-start items-start mr-12 p-5 gap-10 bg-gradient-to-r from-white to-pink-50 dark:from-pink-50 dark:to-pink-600 rounded-3xl shadow-lg w-11/12">
            <p className="text-gray-700 dark:text-white font-bold text-2xl p-5 2xl:text-5xl md:text-4xl text-shadow-lg md:text-shadow-lg text-lg text-center w-1/2"> DeltaHacks</p>
            <div className="flex flex-col justify-start items-start p-5 gap-3 w-1/2">
          ...
          {/*NSBE McMaster*/}
          <div className="flex flex-row justify-start items-start mr-12 p-5 gap-10 bg-gradient-to-r from-white to-pink-50 dark:from-pink-50 dark:to-pink-600 rounded-3xl shadow-lg w-11/12">
            <p className="text-gray-700 dark:text-white font-bold text-2xl p-5 2xl:text-5xl md:text-4xl text-shadow-lg md:text-shadow-lg text-lg text-center w-1/2"> NSBE McMaster</p>
            <div className="flex flex-col justify-start items-start p-5 gap-3 w-1/2">
          ...
          {/*McSCert*/}
          <div className="flex flex-row justify-start items-start mr-12 p-5 gap-10 bg-gradient-to-r from-white to-pink-50 dark:from-pink-50 dark:to-pink-600 rounded-3xl shadow-lg w-11/12">
            <p className="text-gray-700 dark:text-white font-bold text-2xl p-5 2xl:text-5xl md:text-4xl text-shadow-lg md:text-shadow-lg text-lg text-center w-1/2">McSCert Lab</p>
            <div className="flex flex-col justify-start items-start p-5 gap-3 w-1/2">
