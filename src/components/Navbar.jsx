...
const Navbar = () => {
  ...
  return (
    <nav className="bg-primary mb-10 flex items-center justify-center y-3 px-4 md:px-9 fixed top-0 w-full shadow-2xl">
        <div className="flex justify-between items-center w-11/12 p-3 md:p-0"> 
            ...
            <div onClick={handleClick} className="md:hidden z-10">
                <FaBars className=" text-white w-5 h-auto hover:cursor-pointer"/>
            </div>
